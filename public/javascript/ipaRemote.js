...
// Service names
var IPA_DIALOG_NAME = "connectorzzz-dialog"; // REPLACE with your own name
var IPA_CLASSIFIER_NAME = "connectorzzz-classifier-bis";  // NO NEED TO RENAME THIS ONE unless you want to
...
var INTENT_TYPE_CONNECTORZZZ = "action-connectorzzz-info";
...
function isDialogRequiredIntent() {
    return intentType == INTENT_TYPE_DIALOG_EMAIL || intentType == INTENT_TYPE_DIALOG_MEETING || intentType == INTENT_TYPE_DIALOG_SMS|| intentType == INTENT_TYPE_CONNECTORZZZ;
}
